<script lang="ts">
	...
	import Agent from '../icons/Agent.svelte';
				...
				<div class="pb-1.5">
					...
					<div class="px-[0.4375rem] flex justify-center text-gray-800 dark:text-gray-200">
						<a
							...
							on:click={itemClickHandler}
							draggable="false"
							aria-label={$i18n.t('Agentes')}
						>
							<div class="self-center">
								<Agent className="size-4.5" strokeWidth="2" />
							</div>

							<div class="flex self-center translate-y-[0.5px]">
								<div class=" self-center text-sm font-primary">{$i18n.t('Agentes')}</div>
							</div>
						</a>
					</div>
